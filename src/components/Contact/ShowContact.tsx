...
const ShowContact: React.FC<ShowContactProps> = ({ setEditClick }) => {
  ...
  return (
    <div className="flex flex-wrap gap-4">
      {contactList.map((list) => (
        <div
          className="w-full flex flex-col bg-gray-100 text-center rounded-md py-4 px-2"
          key={list.id}
        >
          ...
          <div className="flex justify-around mt-6">
            ...
            <button
              ...
              className="w-fit bg-red-500 font-sans font-semibold text-lg text-white rounded-md py-2 px-4 hover:opacity-90"
            >
              Delete
            </button>
          </div>
